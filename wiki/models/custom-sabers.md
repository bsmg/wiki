...
or on the [GitHub Page](https://github.com/ToniMacaroni/SaberFactory/releases) for the mod. Put the mod in [your install folder](/faq/install-folder.md) to install it. Once you've installed it you will see a folder called `CustomSabers` in
