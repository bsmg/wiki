...
If you've ever made a custom shader or downloaded one from a niche source, there's an extremely high chance it's *not* included.
...
It *will* create .shaderbackup files, but it's always recommended to
...
However, there's a *lot* of different types of shaders, and the autoconverter is only so smart.
...
The exported files are also identical to any other model file. All of your shaders are *compiled* into a bundle,
...
However, this is *clearly* not ideal if you create public models. If somebody's downloaded
