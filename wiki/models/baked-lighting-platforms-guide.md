...
For the **GameObjects** that cast and receive shadows in the Inspector in the **Mesh Render** section you must set these options.
* **Cast Shadows** **On**
...
### **2. Add UV Coordinates to All Objects**
...
### **3. Set All GameObjects and Lights to Static**
...
### **4. Use a Baked Lighting Compatible BeatSaber Shader**
...
### **1. Use Tweak55 to Change the Menu Light**
...
### **2. Change the Colored Lights in Game**
...
### **3. Other MODs Can Add Lights Which Affect the Platform**
