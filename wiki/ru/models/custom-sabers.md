...
## Установка
::tip ПРИМЕЧАНИЕ Мечи должны быть сделаны отдельно для Quest или ПК, и не быть связанными между ними. Вы можете определить, для какой платформы был создан меч по формату файла. `.saber` files are for PC while Quest uses `.qsaber` or `.whacker` files. :::
