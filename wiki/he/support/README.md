...
## 0. עדכונים
After an update, the BSMG discord `#server-announcements` channel should have the most up to date instructions on the status of mods. להלן הוראות מפורטות יותר של התהליך הנפוץ ביותר.
