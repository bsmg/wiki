...
![Hitboxy bloků](/.assets/images/mapping/hitbox-from-split.jpg)

## Umístění

_Jak vlastně funguje světové umístění? Co jsou to body za výkon (PP)? Co jsou ta čísla vedle mých skóre? Proč jsou mé PP tak malé?_
