...
:::warning Disclaimer This guide was originally written on February 7th, 2019. It has been updated multiple times but some information may be inaccurate or missing. Se noti informazioni inaccurate/mancanti in questa guida, puoi inviare una richiesta di pull sulla [Wiki di GitHub di BSMG](https://github.com/bsmg/wiki#readme) o inviarmi un messaggio su Discord (TeknozFR#6900). :::
