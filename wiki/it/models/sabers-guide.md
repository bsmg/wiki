...
Each shader is different, so there's no universal approach to doing this. Se non sei esattamente sicuro di come sia, sentiti libero di discutere il processo in #pc-3d-modeling in [Beat Saber Modding Group](https://discord.gg/beatsabermods).