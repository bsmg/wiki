...
* Use the correct channels please, `#pc-help` for pc mod support and `#quest-help` for quest mod support. Usa `#pc-3d-modeling` e `#quest-3d-modeling` per domande sulla **creazione dei tuoi avatar, piattaforme, note o sciabole** e `#mapping-discussion` per domande sulla **creazione di mappe.**
