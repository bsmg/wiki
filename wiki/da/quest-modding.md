...
:::warning ADVARSEL Installering af BMBF og modding af dit spil vil deaktivere Officiel Multiplayer, samt visning og uploadning af scores på ranglisterne. If you would like to play modded multiplayer, you need the mods, `Beat Together` and `MultiplayerCore`, which allows for cross-play between PC and Quest and for custom songs to be used. These mods should automatically be installed when setting up BMBF.
