...
* Use the correct channels please, `#pc-mod-support` for pc mod support and `#quest-mod-help` for quest mod support. Use  `#pc-modeling` and `#quest-asset-dev` for questions about **making your own avatars, platforms, notes, or sabers**, and `#mapping-discussion` for questions about **making maps.**
