...
# 지원
## 목차
0. [중요 사항](#0-important-notes)
1. [설치 프로그램 관련 문제](#1-installer-issues)
2. [게임 관련 문제](#2-game-issues-post-modding)
3. [자주 묻는 질문](#3-common-questions)
4. [문제 해결하기](#4-troubleshooting)
5. [모두 시도해봤는데 안 돼요!](#5-if-all-else-fails)
6. [여전히 문제가 발생해요!](#6-still-having-issues)

## 0. 업데이트
비트 세이버 업데이트 후에는 BSMG 디스코드의 `#server-announcements` 채널에서 모드 호환성 여부 등에 관한 공지가 올라갑니다. 아래 사항들은 사람들이 자주 겪는 문제에 대한 해결 방안들입니다.

#### 업데이트 후 모드가 작동하지 않아요!
업데이트 후, **게임을 한 번 실행시켜 주시기 바랍니다.** Then, reinstall your mods using an installer linked in the [beginner's guide](/beginners-guide), such as Mod Assistant.
