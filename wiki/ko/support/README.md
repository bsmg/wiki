...
3. [자주 묻는 질문](#_3-common-questions)
4. [Miscellaneous Troubleshooting](#_4-miscellaneous-troubleshooting)
5. [Still Having Issues](#_5-still-having-issues)

## 0. 업데이트
After an update, the BSMG discord [#modding-announcements](https://discord.com/channels/441805394323439646/612468002243477505) channel should have the most up to date information on the status of mods. 아래 사항들은 사람들이 자주 겪는 문제에 대한 해결 방안들입니다.
