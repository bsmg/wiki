...
## 0. 업데이트
After an update, the BSMG discord `#server-announcements` channel should have the most up to date instructions on the status of mods. 아래 사항들은 사람들이 자주 겪는 문제에 대한 해결 방안들입니다.
