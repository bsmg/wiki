...
Sommige editors maken automatisch een `Autosaves` map waar je oudere kopieën kunt ophalen als dit nodig is. When you're ready to prepare your song for upload you must have a minimum of four files.
...
- Standaard muren kunnen worden gelezen door elke headset en hebben de hoogste compatibiliteit. New mappers should stick with these until they're a bit more experienced.
...
- Bommen zijn moeilijk te zien als er geen verlichtingsevenementen actief zijn. Make sure your map isn't dark when bombs are coming up. Zie [basis verlichting](./basic-lighting.md) voor meer tips.
...
Voordat je serieus begint met het maken van levels moet je nadenken over het ritme van het nummer wat je wilt mappen. You'll place blocks on one or more of the main instruments in the song: the drum beat, lead instrument, bass, synths, or even vocals.

To place blocks in time with the rhythm you'll need to change your cursor precision. De meeste (maar niet alle) nummers zullen 1/1, 1/2, of 1/4 cursor precision gebruiken om op de beat te komen. Sommige nummers kunnen "triplets" of 1/3 cursor precision gebruiken, wat moeilijk onderscheiden kan worden van 1/4 voor een onervaren oor. You should not need to use less than 1/4 cursor precision for most songs _including_ mapping to vocals.

::: warning  
90% of the time, mapping with high precision (1/16, 1/32, or 1/64) will make your song mistimed. Als je een hoge precisie nodig hebt om je blokken goed neer te leggen, dan is er iets mis gegaan tijdens het instellen van jouw audiobestand. STOP and review [Basic Audio Setup](./basic-audio.md) to ensure you're in sync! :::
...
When timing out your map you'll want to double check EARLY that the waveform in your editor is lined up with the major lines of the editor track. Als jouw golfvormen niet overeenkomen, bekijken dan de [standaard audio setup](./basic-audio.md) van de wiki opnieuw voor tips.

::: danger CAUTION  
If your waveform isn't lined up it will make it **very** difficult to place blocks in time with the music. Doe dit goed voordat je begint of loop het risico dat je later opnieuw moet beginnen! :::
...
|          Heeft audio bewerkingen/start offset nodig of heeft de verkeerde BPM.          |                                      You're ready to map!                                      |
