...
::: tip INFORMATIE  
Als je feedback hebt over hoe we de hulpmiddelen kunnen verbeteren, vul dit [formulier](https://docs.google.com/forms/d/e/1FAIpQLSfVS6_EMZOujxthR3lTa2eEwHg5C3x1INouLgnbHhBDpv1M5A/viewform) in!  
Je kan ook `#mapping-discussion` bezoeken op de [Bij Saber Modding Group Discord](https://discord.gg/beatsabermods) om mee te doen! :::
...
4. Maak levels! Review [basic mapping practices](./basic-mapping.md) before you start. [Test](#playtesting) je eigen werk vroeg en vaak tijdens het maken van het level.
...
**Onthoud:** De geschreven handleidingen op deze wiki zijn up-to-date omdat het makkelijker en sneller is om deze te wijzigen.
...
#### Legacy Videos
::: warning WAARSCHUWING Deze series gebruiken oudere editors in hun video totorials (Mediocre Mapper en EditSaber). De UI en sommige processen zijn veranderd in de laatst aanbevolen editor, [MMA2](./mediocre-map-assistant.md) maar de rest van de inhoud is geweldig! :::
...
::: tip Interested in making your own editor or converter? Misschien vind je de [Map Formaat Pagina](./map-format.md) en de [SongCore Readme](https://github.com/Kylemc1413/SongCore/blob/master/README.md) handig! :::
...
Je bent nu klaar om door te gaan met bewerken van je level!

### Extra tools voor het maken van levels
* [BeatMapperTools](https://mappers.beatmappertools.com/) van **Darkuni**  
...
* [noodleLister](https://github.com/bloodcloak/noodleLister#readme) van **Bloodcloak**  
  Gemakkelijk een playlist bestand maken vanuit een .txt bestand dat BeatSaber level keys erin heeft.
* [BeatMerge](https://github.com/ZelonGames/BeatMerge#readme) van **DarkGrisen**  
  Ooit gedacht dat het veel en vervelend werk is om grootte levels te maken met meerdere mensen, of het audiobestand perfect knippen om het later handmatig samen te kunnen voegen? Dit hulpprogramma stelt je in staat twee of meer levels samen te voegen in één super lang level.
...
### Handige Mods
Hier zijn enkele mods die het voor jouw makkelijker zouden kunnen maken om aan levels te werken.
...
* [PracticePlugin](https://github.com/Kylemc1413/PracticePlugin) van **Kyle1413**  
  Een mod voor Beat Saber om de afspeelsnelheid te beheren, door nummers zoeken en het maken van herhalende secties. Installeer de nieuwste versie met [ModAssistant](https://github.com/Assistant/ModAssistant#readme)!
...
* Voordat je rangschikking aanvraagt moet je grondig de ranking criteria en [metadata standaarden](https://docs.google.com/document/d/1ehotupIYMVlc8x41JldO-24m7Am-oTVYnciF9KCRdNM/edit) doornemen en je level gemod hebben door een betrouwbare bron. :::tip Wil je een nog gedetailleerde kijk? Bekijk het [Rangking Team Handboek](https://scoresaber.com/criteria) voor een aantal van de meer ambitieuze overwegingen. :::
* Zodra jouw level gemod en herzien is, is het klaar om ingeleverd te worden via de ScoreSaber discord voor beoordeling door het ranking team (wat uit meerdere extra rondes van strenge moddingen en herzieningen bestaat).
* Als een ranking team lid een level geschikt vind word deze toegevoegd aan de rangschikkings wachtrij om op gestemd te worden door het volledige ranking team.
...
* [Het gebruik van Flash & Fade Lighting Events](https://bsaber.com/creating-lighting-how-flash-fade-notes-actually-work-in-game/) door ManDynasty
...
Nog niet klaar om je eigen verlichting te maken? Hier zijn enkele programma's om het voor je doen. Houd het in gedachten dat het creëren van een eenvoudige handmatige verlichting niet moeilijk is en altijd beter zal zijn om de sfeer van het lied uit te drukken dan wanneer je deze programma's gebruikt.
...
## Playtesting
Je werk testen is een **kritisch** deel van het maken van levels. Testen terwijl je werkt helpt je om grote spelbaarheidsproblemen problemen aan te passen en om een gevoel voor je level te krijgen. Het testen van levels [door de community of door anderen](#testen-door-de-community-of-door-anderen) is wanneer iemand anders dan jezelf jouw pre-release level test en hier constructieve feedback op geeft, en het helpt in het duidelijk maken van problemen waarvoor jij misschien "map blind" bent.

::: warning Je **hoeft niet** jouw level te uploaden naar BeatSaver om het te laten testen. :::
...
2. Access your map in-game via the CustomWIPLevels category in the bottom song pack menu. Gebruik oefenmodus om te spelen (de kleine knop naast de gele afspeelknop).
...
2. Ga naar het `Tools` tabblad in BMBF. Daar zou je een webadres en versie nummer moeten zien die vergelijkbaar zijn met wat hier onder word weergegeven.  
   ![ip](~@images/mapping/ip.png)
3. Open een moderne webbrowser op jouw PC en typ het adres in de zoekbalk. Je zou nu met het scherm hieronder begroet moeten worden.  
...
4. Typ in een webbrowser: "192.168.X. XX:50000" waarin X wordt vervangen door het IP weergegeven in SideQuest, of het Tools menu  
...
2. Eenmaal geüpload, klik op Sync to Beat Saber rechts bovenin de pagina. ![](~@images/mapping/bmbf_browser.png)
3. Access your map in-game via the Custom Songs playlist in the bottom song pack menu. Gebruik oefenmodus om te spelen (de kleine knop naast de afspeelknop).
...
* Levels met minder dan 1 minuut wat gemaakt is zullen niet veel feedback krijgen of getest worden. Overweeg om in `#mapping-discussion` te vragen om te zien of iemand in plaats daarvan een kijkje neemt.
...
Geïnteresseerd in helpen? Zie [Hoe test je](./hoe-test-je.md) om aan de slag te gaan!

1. Maak een gecomprimeerd .zip-bestand van de individuele levelbestanden [How to Video](https://streamable.com/u20ci).
2. Upload je level naar `#testplay` met het volgende formaat:
  ...
  * **Difficulty:** welke niveaus zijn meegegeven en de blokken per seconde van elk niveau
  ...
  * **Status:** Wat is de status van het level? (d.w.z. het eerste concept voltooid, geen verlichting; 1:45 gemaakt; release kandidaat met verlichting; etc.)
...
:::warning Onthoudt: als je wijzigingen aanbrengt na het plaatsen of ontvangen van feedback Reageren met een 🛑 `:octagonal_sign:` om aan te geven dat mensen moeten stoppen met het testen van deze versie   
:::
...
* Upload **GEEN** levels die gemaakt zijn door auto-generatie software zoals Deepsaber of Beat Sage. Gebruik alsjeblieft hun kanaal op Discord om de gegenereerde levels te delen! :::
...
Dit is de standaard foutmelding, dit wordt onder andere door het volgende veroorzaakt:
  * Een upload die dicht bij of boven de limiet van 14,3 MB ligt. De vermelde 15 MB is op dit moment niet accuraat. Verminder de kwaliteit van de audio-export een klein beetje om ruimte te maken.
...
**Beatmap could not be parsed!**
  * Dit kan worden veroorzaakt door extreme server drukte. Probeer het later opnieuw of vraag het in `#mapping-discussion`.
___
**Field `._customData._contributors[]._iconPath` contains an invalid filename.**
* Het gebruik van het contributions veld vereist dat alle aspecten worden opgenomen. Zorg ervoor dat alle 3 aspecten (Rol, Naam, iconPath) zijn ingevuld en er een unieke vierkante afbeelding is voor elke invoer van het iconPath in jouw zip.
___
...
Om te voldoen aan het nieuwe schema, vind en verwijder of vul **lege velden** in jouw `info.dat` of niveau bestanden in.

### BeastSaber
[BeastSaber](http://www.bsaber.com) is een site met beoordeling en curatie met een sociale kant voor leden profielen, forums, nieuws en gidsen. Alle gepubliceerde level op BeatSaver worden binnen 10-15 minuten weergegeven op BeastSaber. Het kan een dag duren voordat levels die zijn verwijderd van BeatSaver ook worden verwijderd van BeastSaber.
