...
:::warning Advertencia Instalar BMBF y modificar tu juego desactivará los servidores multijugador oficiales al igual que ver y subir puntuaciones en los marcadores del juego base. If you would like to play modded multiplayer, you need the mods, `Beat Together` and `MultiplayerCore`, which allows for cross-play between PC and Quest and for custom songs to be used. These mods should automatically be installed when setting up BMBF.
