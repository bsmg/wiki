...
* **Desplazamiento de Distancia de aparición** es un modificador que aumenta la distancia de aparición. This can make the NJS feel slower since the blocks will spawn further away and the player has more time to react.
