...
## brian
Creador de CustomUI, haciendo que la creación de nuevos componentes de la interfaz de usuario sea una brisa para modders. He's also created some of the most useful streaming tools used today, including taking over CameraPlus in xyonico's absence and the widely used Enhanced Stream Chat mod. ¡Este hombre quiere más canciones de hip hop, pónganse a ello gente!
...
## DaNike
Creator of the custom-tailored version of IPA (illusion plugin architecture) BSIPA, a mod injector to allow Beat Saber to use mods. Una increíble herramienta que hace que moddear beat saber sea tan fácil como lo es.
...
## Goobie
Mantenedora de los mods que te ayudan a jugar con tus amigos de la manera correcta. Considers herself best girl but thinks that Zenject needs more simps instead.
