...
description: Aprenda como começar a iluminar o seu mapa manualmente!
---

# Iluminação Básica
_Faça o Beat Saber um lugar mais brilhante iluminando manualmente seus mapas_
...
|      ![Image of Triangle environment](~@images/mapping/triangle_env16.jpg)       | **Triangle Environment**<br />**Nome do Info.dat:** `TriangleEnvironment`<br />**Cores Padrões:** Red & Blue<br />**Central Lighting:** :white_check_mark:<br />**Lasers:** :white_check_mark: (esquerod & direito)<br />**Track Ring:** :white_check_mark: (compact square) <br />**Inner Ring:** :white_check_mark: (triangle)<br />**Equalizer:** :white_check_mark:<br />**Nota:** A partir da 1.6 os Back Top Lasers estão embaixo dos Track Lasers <br /><br />**Video Preview:** [Streamable](https://streamable.com/tbvqoq), [YouTube](https://youtu.be/ErRIYIGQKOQ)                                                                                                                  |
