...
Mais de *trinta* guias e tutoriais diferentes de mapping foram combinados nesta wiki para que ela possa ser mantida pela comunidade como um todo. Muitos Muitos **MUITISSIMOS** obrigados aos mappers que traçaram esta trilha e contribuíram com conteúdo. Confira seus mapas e considere apoiá-los!
...
## CyanSnow
Um furry nas segundas e quartas-feiras, faz mapas incríveis com vários gimmicks. Verificou informações sobre um monte de coisas e contribuiu para a seção de paredes no Intermediate Mapping!  
...
## Hexagonial
Escreveu um guia sobre padrões proibidos nos mapas E+ que foi integrado à seção [Mapping Básico: dificuldade em determinar dificuldade & Down-Mapping](./basic-mapping.md#gauging-difficulty-down-mapping). Também é um membro da ranking team!  
[BeatSaver](https://beatsaver.com/uploader/5cff0b7398cc5a672c84f2fb) | [BeastSaber](https://bsaber.com/members/hexagonial/)

## Kival Evan
Contribuiu para as [melhores práticas de&deg;360&deg;/90](./extended-mapping.md#_360°-90°-best-practices) graças à extensa experimentação com o novo modo.  
...
## ManDynasty
Escreveu varios guias para lighting que foram integrados no [Basic Lighting](./basic-lighting.md).  
...
## Pyrowarfare
Um Bsaber curator que escreveu a maioria do conteúdo nas páginas [How to Playtest](./how-to-testplay.md), [Mapping Anxiety](./mapping-anxiety.md) e contribuiu com varias outras páginas.  
...
## Skeelie
Traz danos aos olhos com seus lightshows piscantes, ele pode ajudá-lo a fazer seus mapas brilharem! Contribuiu para a seção [Advanced Lighting](./advanced-lighting.md).   
...
## Spooky Ghost
Criador de beatwalls, uma ferramenta de command line para criar facilmente paredes do Mapping Extensions incríveis. Contribuiu com conteúdo para a página [Extended Mapping: Wall Mapping](./extended-mapping.md#wall-mapping).  
...
## Sykes
Escreveu guias sobre o que é fazer "swing", como o parâmetro "shuffle" tornaria o mapping mais fácil e o down-mapping de dificuldades mais baixas.   
[BeatSaver](https://beatsaver.com/uploader/5cff0b7698cc5a672c854602) | [BeastSaber](https://bsaber.com/members/sykes19/)

## Uninstaller
Membro da ranking team que criou um guia sobre fazer mod de mapas para ranking.  
