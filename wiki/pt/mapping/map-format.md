...
```json
{
    ...
    "_songTimeOffset": 0,
    "_customData": {
        // Qualquer custom data vai aqui. Se vazio, será removido completamente.
    },
    "_difficultyBeatmapSets": [
        // Difficulty beatmap sets (e difficulty beatmaps) são explicados depois nessa página. Verifique a barra lateral!
    ]
}
```

### _version
Este campo descreve a versão do formato do mapa que estamos usando. Atualmente, o formato de mapa de Beat Saber é a versão `2.0.0`.
    ...
    "_difficultyBeatmapSets": [
        {
            ...
            "_difficultyBeatmaps": [
                // Difficulty beatmap é explicado mais abaixo nessa página. Verifique a barra lateral!
            ]
        }
    ]
}
...
### _notes
Esta é uma matriz de objetos [Nota](#notes-2) para o mapa.

### _obstacles
Esta é uma matriz de objetos [Obstaculos](#obstacles-2) para o mapa.

### _events
Esta é uma matriz de objetos [Event](#events-2) para o mapa.
...
### _cutDirection
Isto indica a direção de corte para a nota.

| `_cutDirection` | Resultado           |
|:---------------:| ------------------- |
|       `0`       | Cima                |
|       `1`       | Baixo               |
|       `2`       | Esquerda            |
...
### _time
O tempo, em batidas, onde este objeto atinge o jogador.
...
### _type
Um número inteiro que representa o estado do obstáculo.
...
### _type
Um número inteiro que representa o tipo exato de evento que este objeto representa.
