...
_Prepara o teu arquivo de áudio para criar o teu mapa_
...
9. Pronto. You can now skip to [exporting](#exporting) or go to [optional audio editing](#optional-audio-editing).
...
## Créditos
O conteúdo desta página é derivado de guias de [Kolezan](./mapping-credits.md#kolezan) & [Nik](./mapping-credits.md#nik-n3tman).